/* -----------
 *
 * Program to choose between two melodies by using a potentiometer and a piezo
 * buzzer. Inspired by:
...
int melody1[] = {a4, R, a4, R, a4, R, f4, R, c5, R, a4, R, f4, R, c5, R, a4, R,
                 e5, R, e5, R, e5, R, f5, R, c5, R, g5, R, f5, R, c5, R, a4, R};
int beats1[] = {50, 20, 50, 20, 50, 20, 40, 5,  20, 5,  60, 10,
                40, 5,  20, 5,  60, 80, 50, 20, 50, 20, 50, 20,
                40, 5,  20, 5,  60, 10, 40, 5,  20, 5,  60, 40};

// Melody 2: Star Wars Theme
int melody2[] = {f4,  f4, f4, a4s, f5, d5s, d5, c5,  a5s, f5,
                 d5s, d5, c5, a5s, f5, d5s, d5, d5s, c5};
int beats2[] = {21, 21, 21, 128, 128, 21, 21, 21, 128, 64,
...
int rest_count =
    50; // Loop variable to increase Rest length (BLETCHEROUS HACK; See NOTES)
...
void loop() {
  potVal = analogRead(
      potPin); // Read potentiometer value and store in potVal variable
